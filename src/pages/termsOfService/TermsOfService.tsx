  ...
  return (
    <div className="content-container mx-auto max-w-4xl px-4 py-8">
      ...
      <p>
        ...
        restrictions and may be terminated by Rizmic Fits at any time. Upon
      ...
      <p>
        You must register for an account to use Rizmic Fits. When registering,
        you agree to provide accurate, current, and complete information about
        yourself. You are responsible for maintaining the security of your
        account and password. Rizmic Fits will not be liable for any loss or
      ...
      <p>
        Rizmic Fits offers a monthly subscription service that allows enhanced
        features of our platform. This service is billed on a recurring basis,
        and you agree to allow Rizmic Fits, through our payment processor
        Stripe, to charge your credit card for such recurring charges.
        Subscription fees are non-refundable, except as required by law. You may
        cancel your subscription at any time from your account settings. Your
      ...
      <p>
        ...
        non-exclusive, worldwide, royalty-free license to use, reproduce, adapt,
        publish, translate, and distribute your content in any existing or
        future media. You also grant other Rizmic Fits users the right to access
      ...
      <p>
        Rizmic Fits may revise these terms of service for its web application at
        any time without notice. By using this web application you are agreeing
