          ...
          <div className="flex">
            <div className="">
              ...
              <p className="leading-relaxed">
                ...
                authenticity through their wardrobe choices. By combining our
                love for fashion with technology, we strive to make Rizmic an
                indispensable tool for people looking to explore and refine
          ...
          <div className="flex">
            <div>
              ...
              <p className="leading-relaxed">
                ...
                express their personalities, we sought to create a platform that
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8 ">
          <div className="flex flex-col items-center">
            ...
            <div className="mt-2 h-auto w-80 text-center">
              ...
              Labs. He has a passion for software development and intends to get
              into the field of ML and AI.
            </div>
